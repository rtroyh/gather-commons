package com.gather.gathercommons.xml.digitalsignature;
...
public class CreateEnvelopingSignature {
    static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(CreateEnvelopingSignature.class);
    ...
    public static void main(String unused[]) throws
...

        {
            ...
            Element anElement = doc.createElementNS(null,
                                                    "InsideObject");
